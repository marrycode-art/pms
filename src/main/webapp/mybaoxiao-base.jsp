...
<script type="text/javascript">
	function jumpToPage() {
        ...
        var reg = /^[1-9]*[1-9][0-9]*$/;
		if(reg.test(pageNum)){
			window.location.href = "${pageContext.request.contextPath}/bx/myList?pageNum=" + pageNum${queryStr};
		}else {
		    alert("非法页数！");
		}
    }
...
<!--  搜索表单  -->
<form name='form3' id="form3" action='${pageContext.request.contextPath}/bx/myList' method='get'>
...
<tr align="center" bgcolor="#FAFAF1" height="22">
	...
	<c:forEach items="${page.list}" var="bx">
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td align="center">
		<a href='javascript:void(0);'>
			<u>
				<fmt:formatDate value="${bx.bxtime}" pattern="yyyy-MM-dd"></fmt:formatDate>
			</u>
		</a>
	</td>
	<td>${bx.bxremark}</td>
	...
	<jsp:include page="pageTool.jsp"></jsp:include>
</table>
</form>
