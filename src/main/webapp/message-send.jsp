...
<script type="text/javascript">
    $(function(){
        $.ajax({
            type:"get",
            url:"${pageContext.request.contextPath}/employee/getPersonWithEmail",
            dataType:"json",
            success:function(entity){
                if (entity.map.statusCode == 200) {
                    $(entity.map.employees).each(function (index,item) {
						var option = "<option value='"+item.archives.email+"'>"+item.ename+"</option>"
                    	$("#targetEmail").append(option);
                    })
                }else {
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select name="targetEmail" id="targetEmail">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		...
		<img onclick="WdatePicker({el:'sendtime', 'minDate':'%y-%M-%d', 'skin':'twoer'})" src="${pageContext.request.contextPath}/static/js/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">
	</td>
</tr>
<tr >
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<textarea name="content" rows=15 cols=130></textarea>
	</td>
</tr>
