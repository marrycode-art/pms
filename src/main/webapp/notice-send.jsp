         ...
         $.ajax({
             ...
             success:function (entity) {
                 if (entity.map.statusCode == 200) {
                     window.location.href = "${pageContext.request.contextPath}/notice/jsonList";
                 }else {
                     if (!confirm("服务器异常，添加失败，是否留在当前页面？")) {
                         window.location.href = "${pageContext.request.contextPath}/notice/jsonList";
                     }else {
                         return;
                     }
...
<form name="form2" id="form12" href="javascript:void(0)" action="#" method="post">
