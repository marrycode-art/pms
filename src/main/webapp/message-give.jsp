...
<script type="text/javascript">
    $(function () {
        $.ajax({
            type:"get",
            url:"${pageContext.request.contextPath}/email/getMySendEmail",
            success:function (entity) {
                if (entity.map.statusCode == 200) {
                    $(entity.map.emails).each(function (index,item) {
...
<tr bgcolor="#FAFAF1" id="after-content">
