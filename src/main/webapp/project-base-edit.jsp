...
<form id="form2" name="form2" action="${pageContext.request.contextPath}/project/update" method="post">
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select name="comname" id="comname">
			<c:forEach items="${companies}" var="company">
				<option <c:if test="${company.id == project.comname}">selected="selected"</c:if> value="${company.id}">${company.comname}</option>
			</c:forEach>
		</select>
	</td>
</tr>
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input name="comper" value="${project.comper}"/></td>
	<td align="right" bgcolor="#FAFAF1" height="22">项目经理：</td>
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select name="empFk">
			<c:forEach items="${managers}" var="manager">
				<option <c:if test="${manager.eid == project.empFk}">selected</c:if> value="${manager.eid}">${manager.ename}</option>
			</c:forEach>
		</select>
	</td>
</tr>
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input name="buildtime" id="buildtime" value="<fmt:formatDate value="${project.buildtime}" pattern="yyyy-MM-dd"/>"/>
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input name="endtime" id="endtime" value="<fmt:formatDate value="${project.endtime}" pattern="yyyy-MM-dd"/>"/>
